...
/// Makes an [AppBar] widget with the custom styles for this app. This inculdes
/// having the given [title]. It also has the Ergo4All icon in it unless
/// disabled by setting [withIcon] to false.
