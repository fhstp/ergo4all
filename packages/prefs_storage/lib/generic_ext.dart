...
extension GenericPreferenceStorage on PreferenceStorage {
  /// Attempts to get an item from the preference store. The item is expected to be stored as a [String] that can be parsed by passing it through the given [parse] function. Returns `null` if the key was not found.
